...
vim.keymap.set('n', '<leader>h', '<C-w>h', { silent = true, noremap = true, desc = 'Move focus to the left window' })
vim.keymap.set('n', '<leader>j', '<C-w>j', { silent = true, noremap = true, desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<leader>k', '<C-w>k', { silent = true, noremap = true, desc = 'Move focus to the upper window' })
vim.keymap.set('n', '<leader>l', '<C-w>l', { silent = true, noremap = true, desc = 'Move focus to the right window' })

-- Terminal mappings
vim.keymap.set('t', '<Esc>', '<C-\\><C-n>', { silent = true, noremap = true })
vim.keymap.set('t', '<A-h>', '<C-\\><C-n><C-w>h', { silent = true, noremap = true, desc = 'Move focus to the upper window' })
